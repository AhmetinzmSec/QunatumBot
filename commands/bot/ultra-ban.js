...
exports.run = async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .setColor('200b18')
        .setFooter('BÖRÜ, Güvenli Sohbete Merhaba 👋')
    ...
    const unban = async (user) => {
        ...
        try {
            ...
            log.send(new Discord.MessageEmbed().setColor('200b18').setDescription(`> (#${ban.id}) **${message.guild.name}** adlı sunucudan banınız açıldı.`).setFooter('BÖRÜ, Güvenli Sohbete Merhaba 👋'));
            message.channel.send(new Discord.MessageEmbed().setColor('200b18').setDescription(`> (#${ban.id}) **${user.tag}** kişisine atılan açılmayan ban açıldı.`).setFooter('BÖRÜ, Güvenli Sohbete Merhaba 👋'));
    ...
    const list = async () => {
        ...
        const embed = new Discord.MessageEmbed().setColor('200b18').setDescription(`Toplam **${bans.length}** kişi banlı. Açılmayan banlılar listesini aşağıdaki dosyadan görebilirsiniz.`).setFooter('BÖRÜ | Kızıl Pençe');
