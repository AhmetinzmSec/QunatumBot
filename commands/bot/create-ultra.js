...
**Dipnot:** Bazı kanllar silinmemiş gibi görünebilir. Discord dan çıkıp girin düzelir. Kanal ve rol yetkilerinin sizler tarafından ayarlanması gerekmektedir. BÖRÜ yetkileri ayarlayamaz
**Dipnot:** Tüm roller ve kanallar silinecek. Topluluk aktifse kurallar ve topluluk güncellemeleri kanalları silinmez.
`)).then(resulter => {
        ...
        yes.on('collect', async reaction => {
            ...
            message.guild.channels.create('|▬▬| 🦅 BÖRÜ 🦅 |▬▬|', {type: 'category'}).then(parent => {
