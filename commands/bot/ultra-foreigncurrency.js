...
exports.run = async (client, message, args) => {
    ...
    async function get() {
        ...
        const alis = await $("body > div:nth-child(10) > div.detMain.borsaMain.goldMain > div.detR > div.realTimeBox > div.realTimeBoxIn.up > div.realTimeBoxL").text().replace("Alış Fiyatı (TL)", "")
        const satis = await $("body > div:nth-child(10) > div.detMain.borsaMain.goldMain > div.detR > div.realTimeBox > div.realTimeBoxIn.up > div.realTimeBoxR").text().replace("Satış Fiyatı (TL)", "")
    ...
    const embed = new discord.MessageEmbed()
        ...
        .setDescription("Kaynak: milliyet.com")
        .addField("Dolar", `
